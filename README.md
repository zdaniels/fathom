...
| Collaboration | Built-in tasks, member roles, builder/reviewer handoffs, file diffs and recorded test results, human approval, comments during runs, live activity, and optional Linear/Jira issue import and handoff comments. [Setup](docs/collaboration.md). |
